...
import { github, pineapple, pineappleHover, apple, google } from '../assets';
      ...
      {active !== id ? (
        ...
        <>
          <div
            ...
            <p
              className="text-wite sm:text-[14px] text-[12px] 
              max-w-3xl sm:leading-[24px] leading-[18px]
              font-poppins tracking-[1px]">
              Site : {webUrl !== undefined ? <a className='underline' href='https://perfumist.fr'> {name}</a> : "Désactivé"}
            </p>
            <div className="inset-0 flex justify-end m-3">
              ...
              <div
                ...
                className="sm:w-11 sm:h-11 w-10 h-10 
  ...
  return (
    <div className="-mt-[6rem]">
      <motion.div variants={textVariant()}>
        <p className={`${styles.sectionSubText} `}>Développement</p>
